...
PALETTES: dict[str, Palette] = {
    p.name: p
    for p in (
        Palette("yellow", "Yellow", "#fdf3a7", "#e8dc84", "#332f16", "#7a7247", "#c9bd6a"),
        Palette("pink", "Pink", "#ffd1dc", "#efb6c4", "#3a1f27", "#8a5e6b", "#dda2b2"),
        Palette("green", "Green", "#ccf2c8", "#aedbaa", "#1e3320", "#5c7a5e", "#95c493"),
        Palette("blue", "Blue", "#cfe6fb", "#b0cfea", "#17293a", "#566e83", "#93b8d6"),
        Palette("orange", "Orange", "#ffdcb0", "#eec392", "#3b2713", "#836444", "#d9ac79"),
        Palette("grey", "Grey", "#e6e6e6", "#cccccc", "#242424", "#666666", "#b3b3b3"),
    )
}
